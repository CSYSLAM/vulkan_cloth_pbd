...
public:
	...
	void prepareGraphics()
	{
		...
		shaderStages[0] = loadShader(getShadersPath() + "computeclothPBD/cloth.vert.spv", VK_SHADER_STAGE_VERTEX_BIT);
		shaderStages[1] = loadShader(getShadersPath() + "computeclothPBD/cloth.frag.spv", VK_SHADER_STAGE_FRAGMENT_BIT);
		...
		shaderStages[0] = loadShader(getShadersPath() + "computeclothPBD/sphere.vert.spv", VK_SHADER_STAGE_VERTEX_BIT);
		shaderStages[1] = loadShader(getShadersPath() + "computeclothPBD/sphere.frag.spv", VK_SHADER_STAGE_FRAGMENT_BIT);
	...
	void prepareCompute()
	{
		...
		computePipelineCreateInfo.stage = loadShader(getShadersPath() + "computeclothPBD/cloth.comp.spv", VK_SHADER_STAGE_COMPUTE_BIT);
